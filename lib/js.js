...
var JS = me.JS = function(manager, srcFile) {
    ...
    this.compName = path.basename(srcFile, '.js');
};
JS.prototype = {
    logger: function(){
    ...
    buildJSI18nOldVersion: function(){
    ...
    buildJSCSS: function(cssFromLess){
        var modName = this.modName,
            compName = this.compName,
            css = cssFromLess || "";
    ...
    build: function(callback){
        ...
        stack.push(function(stackCallback){
            content =
                ...
                instance.buildJSI18nOldVersion() +
                instance.buildJSI18n() +
                instance.buildJSTempalte();

            stackCallback();
        });

        stack.push(function(stackCallback){
            instance.compileLESS(function(err, css){
                if (!err){
                    cssFromLess = css;
                }
                stackCallback();
        ...
        stack.push(function(stackCallback){
            content += instance.buildJSCSS(cssFromLess);
            content +=
...
JSManager.prototype = {
    ...
    build: function(){
        ...
        logger.debug('start build js components...');
