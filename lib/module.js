...
var AbricosModule = module.exports = function(options){
    ...
    config.pathResolve('directory', 'source.js.dir', true);

    config.pathResolve('^.build.dir', 'build.dir', true);
    config.pathResolve('build.dir', 'build.js.dir', true);

    config.pathResolve('^.temp.dir', 'temp.dir', true);
    config.pathResolve('temp.dir', 'temp.js.dir', true);

    this.logger().debug('initialized module builder');
};
AbricosModule.prototype = {
    ...
    jsLessBuild: function(srcFile, destFile, callback){
    ...
    jsLessDirBuild: function(srcDir, destDir, callback){
        ...
        for (var i = 0; i < files.length; i++){
            (function(file){
                stack.push(function(stackCallback){
                    ...
                    instance.jsLessBuild(file, destFile, function(err){
                        stackCallback(err);
                    })
                });
            })(files[i]);
    ...
    jsBuild: function(callback){
        ...
        // LESS
        stack.push(function(stackCallback){
            instance.jsLessDirBuild(sourceJSDir, tempJSDir, function(err){
                stackCallback(err);
            });
        });
