...
var AbricosModule = module.exports = function(options){
    ...
    // console.log(config._parent._config);
...
AbricosModule.prototype = {
    ...
    jsBuild: function(callback){
        ...
        fse.removeSync(config.get('temp.dir'));
        fse.ensureDirSync(config.get('temp.js.dir'));
        ...
        stack.push(function(stackCallback){
            less(config.get('source.js.dir'), config.get('temp.js.dir'), {lessOptions: {}}, stackCallback);
        });
