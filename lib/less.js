...
module.exports = function (srcDir, dstDir, options, callback) {
        ...
        (function lessFileCompile(lessFileSrc, lessFileDest) {
            stack.push(function (stackCallback) {
                compileLess(lessFileSrc, options.lessOptions, function (err, css) {
                    if (!err) {
                        fs.writeFileSync(lessFileDest, css);
...
var compileLess = function (srcFile, options, callback) {
    options = merge({filename: srcFile}, options);
    options.paths = options.paths || [path.dirname(srcFile)];

    options.lessOptions = merge(lessOptions.parse, options.lessOptions || {})
